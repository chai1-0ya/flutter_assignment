...
import 'package:flutter_assignment/screens/search/components/eventbox.dart';

import '../../../logic/event_cubit.dart';
import '../../../logic/event_state_cubit.dart';
import '../../eventdetail/detail_screen.dart';
...
class _BodyState extends State<Body> {
  ...
  List<EventModel> _searchResult = [];
  List<EventModel> _userdata = [];
